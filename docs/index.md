# Documentación del Proyecto El Alambique Viajero

Bienvenido a la documentación del proyecto "El Alambique Viajero". Esta guía te ayudará a navegar por toda la documentación disponible sobre los viajes de Luke y sus vehículos.
...
- **[Especificación del Ejercicio](../README.md)** - Descripción completa del problema
  - Los viajes de Luke
  - Destinos (París, Buenos Aires, Bagdad, Las Vegas, Japón)
  - Vehículos (Alambique Veloz y otros)
  - Recuerdos típicos de cada lugar
  - Restricciones de viaje
  - Concepto de polimorfismo

- **[Arquitectura del Sistema](architecture.md)** - Diseño y estructura
  - Visión general con diagramas
  - Módulos del sistema (voluntarios, bebidas)
...
│   ├── personajes.wtest   # Tests de Luke
│   ├── destinos.wtest     # Tests de destinos
│   ├── vehiculos.wtest    # Tests de vehículos
│   ├── recuerdos.wtest    # Tests de recuerdos
│   ├── presidentes.wtest  # Tests de presidentes
│   └── modos.wtest        # Tests de modos del Super Convertible
...
4. Ejecuta los tests siguiendo [testing.md](testing.md) (93 tests)
