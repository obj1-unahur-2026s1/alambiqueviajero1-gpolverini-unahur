...
¡Gracias por tu interés en contribuir a este proyecto! Este documento proporciona pautas para contribuir al sistema de modelado de viajes de Luke y el Alambique Viajero.
...
- Respeta el polimorfismo: todos los destinos deben responder a `recuerdo()` y todos los vehículos deben poder ser usados por Luke para viajar
...
.
├── src/                    # Código fuente
│   ├── destinos.wlk        # Definición de destinos (París, Buenos Aires, Bagdad, Las Vegas)
│   ├── recuerdos.wlk       # Objetos de recuerdos (llavero, mate, bidón, etc.)
│   └── vehiculos.wlk       # Vehículos (Alambique Veloz y otros)
...
Ejemplo:
```
Agrega nuevo destino turístico
